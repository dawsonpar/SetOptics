...
export function TopBar() {
  return (
    <div className="pointer-events-none flex items-center justify-between gap-2">
      <div className="pointer-events-auto glass whitespace-nowrap rounded-full px-3 py-2 sm:px-4">
      ...
      <div className="pointer-events-auto flex shrink-0 gap-2">
        <AIGradientBorder className="hidden sm:block">
          <a
            ...
            className="flex items-center gap-1.5 whitespace-nowrap rounded-full bg-surface px-3.5 py-2 font-mono text-[12px] text-white/90 transition hover:text-white"
          >
            Open on SetOptics
            <ArrowUpRight />
          </a>
